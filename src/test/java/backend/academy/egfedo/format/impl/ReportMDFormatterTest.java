...
class ReportMDFormatterTest {

    ReportMDFormatter formatter = new ReportMDFormatter();
        ...
        return Stream.of(
            Arguments.of(
                ...
                """
                    ...
                    | Начальное время | - |
                    | Конечное время | - |
                    | Количество запросов | 49 |
                    | Средний размер ответа | 403b |
                    | Медиана размера ответа | 200b |
                    | 95p размера ответа | 4309b |
                    | Макс. размер ответа | 4543b |
